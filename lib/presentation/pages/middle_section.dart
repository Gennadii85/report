...
class _MiddleSectionState extends State<MiddleSection> {
  ...
  String dropdownValue = Hive.box(VarHave.boxForwardSection).get('subTitle') ??
      VarForMidAft.subTitleListMiddle.first;
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            AppBarSaveButton(
              function: (context) {
                BlocProvider.of<TableCubitMiddle>(context).saveMiddleSection(
...
class TableSectionMiddle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tableCubit = BlocProvider.of<TableCubitMiddle>(context);

    return BlocBuilder<TableCubitMiddle, TableStateMiddle>(
